...
export interface WhatsappRepository {
   ...
   * @param whatsappMessageId The ID generated by the Whapi service to identify a particular message.
   * @returns {Promise<number>} number indicating the source of the message
   * @throws RepositoryException if the message is not found
   */
  getMessageSource(whatsappMessageId: string): Promise<number>
   ...
   */
  updateMessageStatus(whatsappMessageId: string, status: number): Promise<void>
