...
VALUES
    (
        'b7e82f32-af70-48ad-b355-c97629b4afe1',
        'Vladimir Corporation',
        'contact@vladrimir.com',
        'dadsads',
        'Vladimir',
        'Doe',
        'Smith',
...
VALUES
    (
        'cabb92d2-9da7-4e4b-a975-c611f309d8e6',
        'b7e82f32-af70-48ad-b355-c97629b4afe1', -- Vladimir Corporation's business ID
        '3131a73c-6807-494f-91f4-b32fdafa9e22', -- Basic plan ID
        now(),
        now() + interval '1 month',
        true,
...
-- Insert a user for Vladimir Corporation with the name Acme Admin and role of business admin
INSERT INTO
    public.users (
    id,
    NAME,
...
VALUES
    (
        'cf3637c2-35d1-4591-8bda-c7c3304764be',
        'Vladimir Admin',
        'vladimiradmin',
        'securepassword',
        'vladimir.admin@acmecorp.com',
        1, -- business admin
        'b7e82f32-af70-48ad-b355-c97629b4afdb', -- business
        FALSE
    );
...
VALUES
    (
        '27abb056-75a2-48a5-a8b3-46f708221c5c',
        'ACME Corporation',
        'b7e82f32-af70-48ad-b355-c97629b4afe1', -- business_id
        TRUE,
        '{
          "monday": {
            "startTime": "09:00",
...
VALUES
    (
        '3a617457-5d9a-4a0d-8c90-0f466fd5a8b0',
        '27abb056-75a2-48a5-a8b3-46f708221c5c', -- location id
        '1234567890', -- Replace with the actual phone number
        4, -- AUTH WhatsApp status ID
        NOW(),
        FALSE
...
VALUES
    (
        'e0576a66-a543-41e4-88be-6e02b26d3cfd',
        'cf3637c2-35d1-4591-8bda-c7c3304764be', -- business user ID
        '27abb056-75a2-48a5-a8b3-46f708221c5c', -- business location ID
        FALSE
    );
...
VALUES
    (
        '48534d32-b6dd-4715-a305-a29a5fb0bcda',
        1.00, -- Rate
        'b7e82f32-af70-48ad-b355-c97629b4afe1', -- Business ID from your script
        0, --Message lower limit
        100, -- Messages upper limit (can be NULL if not specified)
        FALSE, -- Deleted
        0 -- Currency ID
    ...
    (
        'ee144150-0eb9-4152-aa59-9e94e312eb7e',
        2.00, -- Rate
        'b7e82f32-af70-48ad-b355-c97629b4afe1', -- Business ID from your script
        100, -- Messages lower limit
        NULL, -- Messages upper limit (can be NULL if not specified)
