...
const ContextManagementCard = () => {
    ...
    useEffect(() => {
        const savedMessage = localStorage.getItem('savedContextManagementCard');
        if (savedMessage) {
    ...
    const saveMessage = () => {
        ...
        try {
            ...
            localStorage.setItem('savedContextManagementCard', JSON.stringify({ content: updatedBlocks }));
    ...
    return (
        <Card className='w-[420px] backdrop-blur-sm bg-white/5'>
            <CardHeader className='bg-[#663399] rounded-t-xl p-3'>
                <Handle
                    type='source'
                ...
                <CardTitle className='text-base font-medium flex items-center gap-2'>
                    <Flex className='w-10 h-10 bg-neutral-100/40 backdrop-blur-lg rounded-full' justify='center' align='center'>
                        <BotMessageSquare size='1.5em' color='#e3ff00' />
                    </Flex>
                    <b>Administración de Contextos</b>
                </CardTitle>
            </CardHeader>
            ...
            <CardContent className='flex-shrink-0'>
                ...
                <Flex className='text-center mt-6' justify='center' gap='2'>
                    <Button onClick={() => setShowModal(true)} className='justify-center bg-white'>Nuevo contexto <Plus /></Button>
                </Flex>
            </CardContent>
...
export default ContextManagementCard;
