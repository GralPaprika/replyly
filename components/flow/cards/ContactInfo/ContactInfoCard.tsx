...
import ContactInfoAcordion from './ContactInfoAcordion';
...
const ContactInfoCard = () => {
    ...
    useEffect(() => {
        const savedMessage = localStorage.getItem('savedContactInfo');
        if (savedMessage) {
    ...
    const saveMessage = () => {
        ...
        try {
            ...
            localStorage.setItem('savedContactInfo', JSON.stringify({ content: updatedBlocks }));
        ...
        <Card className='w-[420px] backdrop-blur-sm bg-white/5'>
            ...
            <CardContent className='flex-shrink-0'>
                ...
                <Flex className='text-center mt-6' justify='center' gap='2'>
                    <Button onClick={() => setShowModal(true)} className='justify-center bg-white'>Nueva Sede/Sucursal <Plus /></Button>
                </Flex>
            </CardContent>
